...
ggplot(Edu,aes(x=department,  # speciyfying axes
               y=n_percent, 
               fill=factor(education, levels=c( "Doctor","Master", "Bachelor", "College", "Below College"))))+
...
Though there's an almost comparables mix of education levels of employees across depatment, most of the employees are Bachelor-level educated in all departments. More employees hold Masters in Sales than other departments.



```{r}

ggplot(Enviro,aes(x=department, y=n_percent, # specifying axes and colouring
                  fill=factor(environment_satisfaction, 
